		...
		<form>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
					...
					<!--we use v-model for whole select element, not option-->
					<select
							id="priority"
							class="form-control" v-model="priorities.prioritySelected">
						<option v-for="priority in priorities.priorityOptions">
							{{ priority }}
						</option>
					</select>
				</div>
